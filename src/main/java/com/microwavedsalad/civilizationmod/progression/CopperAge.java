...
public class CopperAge {

    //List of blocked items:
    private static final Set<Item> COPPER_AGE_BLOCKED_ITEMS = Set.of(
            Items.COPPER_BLOCK,
            Items.COPPER_DOOR,
            Items.LIGHTNING_ROD
    );
    ...
    public static void onItemCrafted(PlayerEvent.ItemCraftedEvent event) {
        if (event.getEntity() instanceof ServerPlayer player) {
            ...
            if (daysPlayed < 50 && COPPER_AGE_BLOCKED_ITEMS.contains(result.getItem())) {
                ...
                player.sendSystemMessage(
                        net.minecraft.network.chat.Component.literal(
                                "You need to reach the COPPER AGE (50 Days) before you can craft this item!" +
