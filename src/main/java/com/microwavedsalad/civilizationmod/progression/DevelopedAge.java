...
public class DevelopedAge {

    //List of blocked items:
    private static final Set<Item> DEVELOPED_AGE_BLOCKED_ITEMS = Set.of(
            Items.NETHERITE_AXE,
    ...
    public static void onItemCrafted(PlayerEvent.ItemCraftedEvent event) {
        if (event.getEntity() instanceof ServerPlayer player) {
            ...
            if (daysPlayed < 1000 && DEVELOPED_AGE_BLOCKED_ITEMS.contains(result.getItem())) {
                ...
                player.sendSystemMessage(
                        net.minecraft.network.chat.Component.literal(
                                "You need to reach the DEVELOPED AGE (1000 Days) before you can craft this item!" +
